...
# 
# **ATENÇÃO**: o `franz` consome muito da memória RAM disponível no computador e, mesmo fechando o programa, ele pode continuar em execução. Portanto, tenha cuidado com sua instalação.
# 
